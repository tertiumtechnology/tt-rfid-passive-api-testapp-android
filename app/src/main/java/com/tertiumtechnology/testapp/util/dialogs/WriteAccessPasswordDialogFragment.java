...
public class WriteAccessPasswordDialogFragment extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(dialogView)
                ...
                .setPositiveButton(R.string.write_access_password_write_button, (dialog, id) -> listener.onWriteAccessPassword(oldPasswordText.getText().toString(), newPasswordText.getText
                        ().toString()))
